<?php include('../actions/get-exams.php');?>
      ...
      <div class="section-inner" id = "section-inner">
        <div class="row">
          <div class="col-lg-12 col-xs-12 col-sm-12 col-md-12">
                ...
                <a href = "../actions/view_all_results.php" class="btn pmd-ripple-effect btn-primary pmd-z-depth add-del-button" type="button">View Students' Results</a>
                          </div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header bordered">
                            ...
                            <h2 class="pmd-card-title-text">Add Exam</h2>
                          </div>
                          <form class="form-horizontal" id = "add_exams_form" method = "post" action = "../actions/add_exam.php">
                          <div class="modal-body">
                              <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                <label for="first-name">Subject</label>
                                <input name = "subject" type="text" class="mat-input form-control" id="name" value="">
                              </div>
                              <div class="form-group pmd-textfield pmd-textfield-floating-label">
                              ...
                              <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                ...
                                <input name = "time_allowed" type="text" class="mat-input form-control" id="email" value="">
                              </div>
                              <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                <label for="first-name" class = "pull-right">Questions File (word document)</label>
                                <input name = "question_file" type ="file" class="mat-input form-control" id="email" value="">
                              </div>
                          </div>
                          <div class="pmd-modal-action">
                            <button class="btn pmd-ripple-effect btn-primary" type = "submit" id = "save_exam_buton">Save</button>
                            <a class="btn pmd-ripple-effect btn-default">Discard</a>
                          </div>
                          </form>
                        </div>
                      </div>
